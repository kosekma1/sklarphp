...
<table>
  ...
  <tr>
	...
	Small <br />
	<td><?= $form->input('radio',['name'=>'size', 'value' => 'medium']) ?>
	Medium <br />
	<td><?= $form->input('radio',['name'=>'size', 'value' => 'large']) ?>
	Large <br />
	</td>
  <tr>
  <tr>
  ...
  <tr>
	...
	<td><?= $form->select($GLOBALS['main_dishes'], ['name' => 'main_dishes', 'multiple' => true]) ?></td>
  </tr>	
  <tr>
    <td>Do you want your order delivered, put your address here:</td>
